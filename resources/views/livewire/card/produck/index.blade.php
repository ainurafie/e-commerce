        ...
        <div class="px-6 py-4">
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="w-full">
                    ...
                    <h1 class="text-xs text-[#919191] font-montserrat">{{ $d->terjual }} Terjual</h1>
                </div>
                ...
                <div class="w-full mt-3 gap-2 flex items-center justify-start">
                    ...
                    <button data-modal-toggle="edit-produk{{ $d->id }}" class="text-[#E7E7E7] font-montserrat bg-[#FACA15] text-sm rounded-lg px-2 py-1">Edit</button>


                                                            <!-- Main modal -->
                                        <div id="edit-produk{{ $d->id }}" tabindex="-1" aria-hidden="true"
                                        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
                                        <div class="relative p-4 w-full max-w-xl h-full md:h-auto">
                                            <!-- Modal content -->
                                            <div class="relative rounded-lg px-5 py-8 shadow max-h-[400px] overflow-y-auto bg-white">
                                            <form method="POST" action="{{ route('produk.update', $d->id) }} " enctype="multipart/form-data">
                                                @method('PUT')
                                                @csrf
                                                <h1 class="text-base text-black font-montserrat font-semibold mb-8">Edit Produk</h1>
                                                <div class="relative mb-5  mt-8">
                                                    ...
                                                    <input type="text" id="nama" name="name"
                                                        ...
                                                        placeholder="Nama produk" required value="{{ $d->nama }}">
                                                </div>
                                                <div class="relative mb-5">
                                                    ...
                                                    <input type="number" id="stok" name="stok"
                                                        class="bg-white border border-[#D4EDDA] text-black font-light text-sm rounded-lg block w-full p-2.5"
                                                        placeholder="Isi stok barang" required value="{{ $d->stok }}">
                                                </div>
                                                <div class="relative mb-5">
                                                    <h1 class="text-sm font-medium font-montserrat text-black mb-2.5">
                                                    ...
                                                    <input type="number" id="stok" name="harga"
                                                        class="bg-white border border-[#D4EDDA] text-black font-light text-sm rounded-lg block w-full p-2.5"
                                                        placeholder="Isi Harga Barang" required value="{{ $d->harga }}">
                                                </div>
                                                <div class="relative mb-5">
                                                    <h1 class="text-sm font-medium font-montserrat text-black mb-2.5">
